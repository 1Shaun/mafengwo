...
class Chameleon(object):
    ...
    def __init__(self):
        ...
        #os.system("python3 run.py  -u 'http://www.mafengwo.cn/poi' -o 'output.txt'")
        f = open('output.txt')
        # read txt method one
        self.proxy_list = []
        line = f.readline()
        while line:
            self.proxy_list.append(line.strip()[7:])
            line = f.readline()
        f.close()
    ...
    def get_headers(self):
        ...
        dict_ = {'User-Agent': random.choice(self.ua_list)}
    ...
    def remove(self, proxy):
        ...
        try:
            ...
            print('没有找到该ip')
        print('代理还有：{}'.format(len(self.proxy_list)))
